...
Figures, tables, and statistical values are fully reproducible in the main manuscript as well as the supplemental information using RStudio version 2024.12.1+563 and R version 4.4.1 or higher. All data, code, and images are available publicly in this repository. Instructions for directly reproducing this project are included in the repository. 
